...
public class OutboxInstallerDbContextFactory : IDesignTimeDbContextFactory<OutboxInstallerDbContext>
{
	#region IDesignTimeDbContextFactory<OutboxInstallerDbContext> Members
